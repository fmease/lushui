...
use lushui_utilities::{condition, obtain, Atom};
...
impl Target for ast::Declaration {
    ...
    // @Beacon @Beacon @Beacon @Note this method makes us (cyclically) depend on session! avoid this!
    // @Task move this to the lowerer!!!!!
    fn check_attributes(&self, attributes: &Attributes, session: &BuildSession) -> Result {
        ...
        todo!() // @Beacon @Beacon @Beacon @Temporary
    }
}
