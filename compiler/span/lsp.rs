use super::{ByteIndex, LocalByteIndex, SourceMap, Span};
use std::path::Path;
use tower_lsp::lsp_types::{Location, Position, Range, Url};

impl Span {
    pub(crate) fn to_location(self, map: &SourceMap) -> Location {
...
impl ByteIndex {
    ...
    pub(crate) fn from_position(position: Position, path: &Path, map: &SourceMap) -> Self {
