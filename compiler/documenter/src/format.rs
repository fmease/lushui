...
use lushui_hir::{self as hir, DeclarationIndex, Display};
use lushui_resolver::ComponentExt;
use lushui_session::{Component, DeclarationIndexExt, LocalDeclarationIndexExt, BuildSession};
use std::iter::once;
...
impl<'a> Formatter<'a> {
    ...
    fn look_up(&self, index: DeclarationIndex) -> &lushui_entity::Entity {
